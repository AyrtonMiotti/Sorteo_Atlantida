$(function(){
    ...
    function updateStats(){
      $('#stats').html('<div class="padded"><h2>Estadísticas:  <span>'+
        ...
        '<li><b>Mejor Media:</b> <span>'+toTime( get('flip_medium') )+'</span></li>'+
        '<li><b>Mejor Difícil:</b> <span>'+toTime( get('flip_hard') )+'</span></li></ul>'+
        '<ul><li><b>Flips totales:</b> <span>'+parseInt( ( parseInt(get('flip_matched')) + parseInt(get('flip_wrong')) ) * 2)+'</span></li>'+
        '<li><b>Flips correctos:</b> <span>'+get('flip_matched')+'</span></li>'+
        '<li><b>Flips incorrectos:</b> <span>'+get('flip_wrong')+'</span></li></ul></div>');
    };
