class Game {
    ...
    generateTweet() {
        ...
        window.open("https://twitter.com/intent/tweet?url=https://codepen.io/gregh/full/yVLOyO&amp;text=I scored "
        + this.score
         +" points on Coloron! Can you beat my score?&amp;via=greghvns&amp;hashtags=coloron", 
         "TweetWindow", "width=600px,height=300px,top=" + top + ",left=" + left);
    }
    ...
    * Display score
    ...
    showGrade(score) {
        ...
        else if(score > 15) return "¡Genial!";
        else if(score > 13) return "¡Bien!";
        else if(score > 10) return "Buen Trabajo";
        else if(score > 5) return "¡Podés hacerlo mejor!";
        else return "Ok...";
    }
